...
<script type="text/javascript">
  ...
  headers: {
    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
     ...
     <h2 class="text-center">Payments via Agents </h2>
           <div class="text-right"><a href="/login-via-bank">Pay via bank</a></div>
           <div id="subtext"></div>
...
{{$errors->first()}}
        ...
        @endif
<form  id="joey" role="form" method="POST" action="{{ url('/updateinfosp') }}">
                  {!! csrf_field() !!}
