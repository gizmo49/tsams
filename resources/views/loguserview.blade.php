...
<tr>
            <td>
                <img  src="img/unn.jpg" style="width: 3%; padding-top: 10px; padding-right: 10px;">
            </td>
            <td>
                <img  src="img/coat.jpg" style="width: 5%;">
            </td>
            <td >
                <img src="img/cbn.jpg" style="width: 3%; padding-top: 8px;">
            </td>
            </tr>
            </tbody>
        
<h3 style="color: black; word-spacing: 30px;">Treasury   Single   Account   Managment   System   (TSAMS) </h3>
    ...
    <div class="col-md-4 col-md-offset-4 text-center" >
      ...
      <div class="search-box">
        ...
        <div class="caption" style="margin-bottom: 10px;">
          <h3 style="color: green;">CBN Administrator </h3>
         <img src="./img/cbn.jpg">
        </div>
